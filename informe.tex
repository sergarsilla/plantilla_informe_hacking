...
\title{
    \vspace{2cm}
    \textbf{Memoria de Actividades: Hacking Ético} \\
    \large \textit{Resolución de Salas --- TryHackMe}
    \vspace{3cm}
}
...
\input{rooms/plantilla_room.tex} % Cambia esto por el nombre de tu primera sala
